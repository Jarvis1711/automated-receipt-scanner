...
STATUSES = ["queued", "live", "paused", "closed"]
...
def create_app(test_config=None):
    ...
    app.config.update(
        ...
        APP_TITLE="Automated Receipt Scanner",
        APP_DESCRIPTION="Production-ready domain application.",
        DOMAIN_LABEL="Real-Time SaaS",
        ENTITY_SINGULAR="Automated Receipt Session",
        ENTITY_PLURAL="Automated Receipt Sessions",
    )
